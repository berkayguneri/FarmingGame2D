...
public class Cursor : MonoBehaviour
{
    ...
    private void SetCursorValidity(Vector3 cursorPosition, Vector3 playerPosition)
    {
        ...
        if (cursorPosition.x > (playerPosition.x + ItemUseRadius / 2f) && cursorPosition.y > (playerPosition.y + _itemUseRadius / 2f) ||

            cursorPosition.x < (playerPosition.x - ItemUseRadius / 2f) && cursorPosition.y > (playerPosition.y + _itemUseRadius / 2f) ||
        ...
        //determine cursor validity based on iventory item selected and what object the cursor is over
